...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-73.823820, -23.237492, -53.275860, -9.338710], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
            //extent: [-69.645246, -24.741667, -57.454434, -9.669633],
            units: 'degrees'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([-73.823820, -23.237492, -53.275860, -9.338710], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">ESTACIONES METEOROLOGICAS DE BOLIVIA </h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (105 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'El mapa representa la ubicacion de las las estaciones obtenidas de la bse de datos del SENAMHI - BOLIVIA ';
            }
